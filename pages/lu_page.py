...
# diubah. Seluruh logika matematika dekomposisi LU (PA = LU) beserta data
...
#   (Identik dengan halaman SPL/Determinan/Invers agar desain konsisten.)
# ─────────────────────────────────────────────────────────────────────────────
...
class LUPage(ctk.CTkFrame):
    ...
    # ─────────────────────────────────────────────
    # LAYOUT — Elevated card system (selaras SPL/Determinan/Invers)
    # ─────────────────────────────────────────────
    def _build_layout(self):
        ...
        # (Dekomposisi LU hanya punya satu metode, jadi tanpa segmented button.)
        # ════════════════════════════════════════════════════════════════
        ...
        ctk.CTkLabel(
            info_card,
            text="Faktorkan PA = LU.  P = Permutasi,  L = Lower Triangular,  "
                 "U = Upper Triangular. Isi matriks persegi, lalu jalankan.",
            font=FONT_SMALL,
        ...
        self.calc_button = ctk.CTkButton(
            action_bar, text="⚡   Hitung LU", font=FONT_BUTTON,
