...
# Invers, LU, Eigen, dan Diagonalisasi.
...
# diubah. Seluruh logika matematika SVD (A = UΣVᵀ, numpy) beserta data
...
class SVDPage(ctk.CTkFrame):
    ...
    def _build_layout(self):
        ...
        # (SVD satu alur perhitungan, jadi tanpa segmented button.)
        # ════════════════════════════════════════════════════════════════
        ...
        ctk.CTkLabel(
            info_card,
            text="Σ   Singular Value Decomposition",
            font=FONT_HEADING,
        ...
        ctk.CTkLabel(
            info_card,
            text="Faktorkan A = U·Σ·Vᵀ.  Matriks tidak harus persegi (m×n). "
                 "Hasil dalam bentuk numerik (desimal). Isi matriks, lalu jalankan.",
            font=FONT_SMALL,
        ...
        # ════════════════════════════════════════════════════════════════
        # PANEL 2 — MATRIX WORKSPACE (satu sub-card untuk matriks m×n)
        # ════════════════════════════════════════════════════════════════
        ...
        # Sub-Card: Matriks A (m×n — tidak harus persegi)
        sub_a = ctk.CTkFrame(
            holder,
        ...
        self.matrix_input = MatrixInputWidget(
            ...
            label="Matriks A (m×n)", style=self._matrix_style(toolbar_cols=3),
        )
        ...
        self.calc_button = ctk.CTkButton(
            action_bar, text="⚡   Hitung SVD", font=FONT_BUTTON,
